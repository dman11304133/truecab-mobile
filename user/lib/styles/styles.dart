...
Color buttonColor = const Color(0xff2d4099);
Color theme = const Color(0xff2d4099);
Color splashColor = const Color(0xff2d4099);
...
Color loaderColor = const Color(0xff2d4099);
Color grad1 = const Color(0xff2d4099);
Color grad2 = const Color(0xff000000);
...
Color glassColor = Colors.white.withOpacity(0.15);
Color glassBorderColor = Colors.white.withOpacity(0.2);
double glassBlur = 15.0;
