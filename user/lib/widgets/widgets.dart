  ...
  Widget build(BuildContext context) {
    ...
    return CupertinoButton(
      ...
      child: Container(
        ...
        child: Container(
          height: widget.height ?? media.width * 0.14,
    ...
    return Container(
      ...
      child: Column(
        children: [
              ...
              children: [
                ...
                MyText(
                  text: widget.transfer == null
                      ? '${t('text_amount_of')} $addMoney ${userDetails['currency_symbol']} ${t('text_tranferred_to')} ${userDetails['mobile']}'
                      : '${t('text_amount_of')} ${amount.text} ${userDetails['currency_symbol']} ${t('text_tranferred_to')} ${phonenumber.text}',
          ...
          Button(
              onTap: widget.onTap, text: t('text_ok'))
        ],
      ),
    );
  }
