                  ...
                  children: [
                    ...
                    Expanded(
                      child: MyText(
                        ...
                        text: (_showHistory == 0)
                            ? t('text_upcoming_rides')
                            : (_showHistory == 1)
                                ? t('text_completed_rides')
                                : (_showHistory == 2)
                                    ? t('text_cancelled_rides')
                                    : t('text_enable_history'),
                                                                        ...
                                                                        : (myHistory[i]['is_cancelled'] ==
                                                                            ...
                                                                            : (myHistory[i]['is_later'] == 1)
                                                                                ? (myHistory[i]['is_rental'] == false)
                                                                                    ? t('text_ridelater')
                                                                                    : (t('text_rental') + ' - ' + myHistory[i]['rental_package_name'].toString())
                                                                                : '',
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    MyText(
                                                                        text: (myHistory[i]['is_bid_ride'] ==
                                                                            ...
                                                                            : (myHistory[i]['is_completed'] == 1 && myHistory[i]['requestBill'] != null && myHistory[i]['requestBill']['data'] != null)
