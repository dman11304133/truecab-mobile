                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                MyText(
                                                    text: (myHistory[selectedHistory]['is_bid_ride'] == 1)
                                                        ? myHistory[selectedHistory]['requested_currency_symbol'] +
                                                            ' ' +
                                                            myHistory[selectedHistory]['accepted_ride_fare'].toString()
                                                        : (myHistory[selectedHistory]['is_completed'] == 1 &&
                                                                myHistory[selectedHistory]['requestBill'] != null &&
                                                                myHistory[selectedHistory]['requestBill']['data'] != null)
                                                ...
                                                children: [
                                                  ...
                                                  Column(
                                                    children: [
                                                      ...
                                                      MyText(
                                                        text:
                                                            '${myHistory[selectedHistory]['total_time']} ${t('text_mins')}',
                                                        size:
                                                            media.width * twelve,
                                                        fontweight:
                                                            FontWeight.w500,
                                    ...
                                    (myHistory[selectedHistory]
                                        ...
                                        ? Column(
                                            ...
                                            children: [
                                              ...
                                              (myHistory[selectedHistory]['requestBill'] == null)
                                                  ? MyText(
                                                      text: myHistory[selectedHistory]['requested_currency_symbol'] +
                                                          ' ' +
                                                          myHistory[selectedHistory]['request_eta_amount'].toString(),
                                      ...
                                      onTap: () async {
                                        if (makecomplaint == 1) {
                                          if (complaintText.text.length >= 10) {
                                            ...
                                            dynamic result;
                                            result =
                                                await makeRequestComplaint(myHistory[selectedHistory]['id'].toString(), complaintDesc, complaintType);
                                            if (result == 'success') {
                                              setState(() {
                                                makecomplaint = 2;
                                                _isLoading = false;
