                                                          ...
                                                          InkWell(
                                                            onTap: () async {
                                                              ...
                                                              addressList.add(AddressList(
                                                                  ...
                                                                  pickup: true,
                                                                  latlng: LatLng(
                                                                      double.parse(myHistory[i]['pick_lat'].toString()),
                                                                      double.parse(myHistory[i]['pick_lng'].toString())),
                                                                  name: userDetails[
                                                                      'name'],
                                                                  number: userDetails[
                                                                      'mobile']));
                                                                ...
                                                                for (var i = 0;
                                                                  ...
                                                                  addressList.add(AddressList(
                                                                      ...
                                                                      address: _tripStops[
                                                                          ...
                                                                          'address'],
                                                                      latlng: LatLng(
                                                                          double.parse(_tripStops[i]['latitude'].toString()),
                                                                          double.parse(_tripStops[i]['longitude'].toString())),
                                                                      name: '',
                                                                      number:
                                                                          '',
                                                                      instructions:
                                                              ...
                                                              if (myHistory[i][
                                                                ...
                                                                addressList.add(AddressList(
                                                                    ...
                                                                    address: myHistory[
                                                                        ...
                                                                        'drop_address'],
                                                                    latlng: LatLng(
                                                                        double.parse(myHistory[i]['drop_lat'].toString()),
                                                                        double.parse(myHistory[i]['drop_lng'].toString()))));
                                                              }
