                            ...
                            children: [
                              ...
                              Expanded(
                                  child: Button(
                                      ...
                                      text: (userRequestData['is_paid'] ==
                                          0 &&
                                          userRequestData[
                                          'payment_opt'] !=
                                              '2')
                                          ? t('text_choose_payment')
                                          : t('text_confirm'))),
                            ],
                          )
                              : Container(),
                                                                  ...
                                                                  Column(
                                                                    ...
                                                                    children: [
                                                                      Text(
                                                                        ...
                                                                        style: GoogleFonts.notoSans(fontSize: media.width * fourteen, fontWeight: FontWeight.w500, color: textColor),
                                                                      ),
                                                                      Text(
