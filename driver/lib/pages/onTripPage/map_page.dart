...
class _MapsState extends State<Maps>
  ...
  void _onMapCreated(GoogleMapController controller) {
    ...
    if (center.latitude != 0 &&
        ...
        driverReq.isEmpty &&
        choosenRide.isEmpty) {
      _controller?.animateCamera(CameraUpdate.newLatLngZoom(center, 16.0));
    }
  ...
  addDropMarker() async {
      ...
      for (var i = 0; i < tripStops.length; i++) {
        ...
        if (testIcon != null) {
          myMarkers.add(Marker(
              ...
              icon: testIcon,
              position: LatLng(double.parse(tripStops[i]['latitude'].toString()),
                  double.parse(tripStops[i]['longitude'].toString()))));
        }
      }
      setState(() {});
      ...
      if (testIcon != null) {
        setState(() {
          myMarkers.add(Marker(
              ...
              icon: testIcon,
              position: LatLng(
                  double.parse(choosenRide[0]['drop_lat'].toString()),
      ...
      if (testIcon != null) {
        setState(() {
          myMarkers.add(Marker(
              ...
              icon: testIcon,
              position: LatLng(
                  double.parse(driverReq['drop_lat'].toString()),
    ...
    if (driverReq.isNotEmpty) {
      if (double.parse(driverReq['pick_lat'].toString()) >
              double.parse(driverReq['drop_lat'].toString()) &&
          double.parse(driverReq['pick_lng'].toString()) >
              double.parse(driverReq['drop_lng'].toString())) {
        bound = LatLngBounds(
            southwest: LatLng(double.parse(driverReq['drop_lat'].toString()),
                double.parse(driverReq['drop_lng'].toString())),
            northeast: LatLng(double.parse(driverReq['pick_lat'].toString()),
                double.parse(driverReq['pick_lng'].toString())));
      } else if (double.parse(driverReq['pick_lng'].toString()) >
          double.parse(driverReq['drop_lng'].toString())) {
        bound = LatLngBounds(
            southwest: LatLng(double.parse(driverReq['pick_lat'].toString()),
                double.parse(driverReq['drop_lng'].toString())),
            northeast: LatLng(double.parse(driverReq['drop_lat'].toString()),
                double.parse(driverReq['pick_lng'].toString())));
      } else if (double.parse(driverReq['pick_lat'].toString()) >
          double.parse(driverReq['drop_lat'].toString())) {
        bound = LatLngBounds(
            southwest: LatLng(double.parse(driverReq['drop_lat'].toString()),
                double.parse(driverReq['pick_lng'].toString())),
      ...
      if (double.parse(choosenRide[0]['pick_lat'].toString()) >
              double.parse(choosenRide[0]['drop_lat'].toString()) &&
        ...
        bound = LatLngBounds(
            southwest: LatLng(
                ...
                double.parse(choosenRide[0]['drop_lng'].toString())),
            northeast: LatLng(
                double.parse(choosenRide[0]['pick_lat'].toString()),
                double.parse(choosenRide[0]['pick_lng'].toString())));
      } else if (double.parse(choosenRide[0]['pick_lng'].toString()) >
          double.parse(choosenRide[0]['drop_lng'].toString())) {
        bound = LatLngBounds(
            southwest: LatLng(
                double.parse(choosenRide[0]['pick_lat'].toString()),
            ...
            northeast: LatLng(
                double.parse(choosenRide[0]['drop_lat'].toString()),
                double.parse(choosenRide[0]['pick_lng'].toString())));
      } else if (double.parse(choosenRide[0]['pick_lat'].toString()) >
          double.parse(choosenRide[0]['drop_lat'].toString())) {
        bound = LatLngBounds(
            southwest: LatLng(
                double.parse(choosenRide[0]['drop_lat'].toString()),
...
//getting permission and current location
  getLocs() async {
    ...
    permission = await LocationService.checkPermissions();
      ...
      if (serviceEnabled == true) {
        ...
        if (center.latitude == 0 && center.longitude == 0) {
          ...
          if (driverReq.isEmpty && choosenRide.isEmpty) {
            _controller
                ?.animateCamera(CameraUpdate.newLatLngZoom(center, 16.0));
          }
  ...
  animatePoly() {
    ...
    if (driverReq.isNotEmpty && driverReq['arrived_at'] != null) {
      ...
      if (center.latitude > double.parse(driverReq['pick_lat'].toString()) &&
          center.longitude > double.parse(driverReq['pick_lng'].toString())) {
        bound = LatLngBounds(
            southwest: LatLng(double.parse(driverReq['pick_lat'].toString()),
                double.parse(driverReq['pick_lng'].toString())),
            northeast: LatLng(center.latitude, center.longitude));
      } else if (center.longitude >
          double.parse(driverReq['pick_lng'].toString())) {
        bound = LatLngBounds(
            southwest: LatLng(center.latitude,
                double.parse(driverReq['pick_lng'].toString())),
            northeast: LatLng(
        ...
        bound = LatLngBounds(
            southwest: LatLng(double.parse(driverReq['pick_lat'].toString()),
                center.longitude),
            northeast: LatLng(center.latitude,
                double.parse(driverReq['pick_lng'].toString())));
      } else {
        bound = LatLngBounds(
              ...
              if (navigated == false) {
                ...
                if (driverReq.isNotEmpty) {
                  ...
                  if ((driverReq['is_completed'] == 1 ||
                          driverReq['is_completed'] == '1' ||
                          driverReq['is_completed'] == true) &&
                                                                                                  ...
                                                                                                  Container(
                                                                                                      ...
                                                                                                      child: (driverReq.isNotEmpty)
                                                                                                          ? Text(
                                                                                                              ...
                                                                                                              softWrap: false,
                                                                                                              style: GoogleFonts.poppins(color: buttonText, fontSize: (platform == TargetPlatform.android) ? media.width * ten : media.width * twelve),
                                                                                                            )
                                                                            ...
                                                                            ? Row(
                                                                                ...
                                                                                children: [
                                                                                  Container(
                                                                                    ...
                                                                                    margin: EdgeInsets.all(media.width * 0.005),
                                                                        ...
                                                                        children: [
                                                                                  ...
                                                                                  child: Row(
                                                                                    ...
                                                                                    children: [
                                                                                      OwnerCarImagecontainer(
                                                                                        color: Colors.green,
                                                                                        imgurl: (transportType == 'taxi' || transportType == 'both') ? 'assets/images/available.png' : 'assets/images/available.png',
                                                                                      ...
                                                                                      OwnerCarImagecontainer(
                                                                                        color: Colors.red,
                                                                                        imgurl: (transportType == 'taxi' || transportType == 'both') ? 'assets/images/onboard.png' : 'assets/images/onboard.png',
                                                                                      ...
                                                                                      OwnerCarImagecontainer(
                                                                                        color: Colors.grey,
                                                                                        imgurl: (transportType == 'taxi' || transportType == 'both') ? 'assets/images/offlinecar.png' : 'assets/images/offlinecar.png',
                                                                          ...
                                                                          InkWell(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              decoration: BoxDecoration(image: DecorationImage(image: (transportType == 'taxi' || transportType == 'both') ? const AssetImage('assets/images/bluecar.png') : const AssetImage('assets/images/bluecar.png'), fit: BoxFit.contain), borderRadius: BorderRadius.circular(100.0)),
                                                                            ),
                                                                          ),
                                                                        ],
                                                                      ),
                                                                    ...
                                                                    ? InkWell(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            'SOS',
                                                                            style:
                                                                                GoogleFonts.poppins(fontSize: media.width * twenty, color: buttonText),
                                                                          ),
                                                                        ))
                                                                    : Container(),
                                                                const SizedBox(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Icon(Icons.my_location_sharp, color: textColor, size: media.width * 0.075),
                                                                            ),
                                                                          ),
                                                                        ),
                                                                      ),
                                                                                        ...
                                                                                        Row(
                                                                                          children: [
                                                                                            Container(
                                                                                              ...
                                                                                              decoration: BoxDecoration(shape: BoxShape.circle, image: safeImage(choosenRide[0]['user_img'])),
                                                                                            ),
                                                                                              ...
                                                                                              InkWell(
                                                                                                ...
                                                                                                child: Container(
                                                                                                  ...
                                                                                                  child: Text(
                                                                                                    ...
                                                                                                    style: GoogleFonts.poppins(fontSize: media.width * fourteen, fontWeight: FontWeight.w500, color: page),
                                                                                                  ),
                                                                                                ),
                                                                                              ),
                                                                                              SizedBox(
                                                                                                  ...
                                                                                                  child: Row(
                                                                                                    children: [
                                                                                                      Container(
                                                                                                        height: media.width * 0.2,
                                                                                                        width: media.width * 0.2,
                                                                                                        decoration: BoxDecoration(image: safeImage(driverReq['userDetail']['data']['profile_picture']), borderRadius: BorderRadius.circular(media.width * 0.02), boxShadow: [BoxShadow(blurRadius: 2, color: textColor.withOpacity(0.2), spreadRadius: 2)], color: page),
                                                                                                      ),
                                                                                                      SizedBox(
                                                                                                        width: media.width * 0.05,
                                                                                                      ),
                                                                                                      Expanded(
                                                                                                        ...
                                                                                                        children: [
                                                                                                          ...
                                                                                                          Row(
                                                                                                            children: [
                                                                                                              MyText(
                                                                                                                text: (aproximateDistance != null) ? '${double.parse(aproximateDistance.toString()).toStringAsFixed(2)} km' : '0.00 km',
                                                                                                                size: media.width * fourteen,
                                                                                                                // fontweight: ui.FontWeight.w500,
                                                                                                              ),
                                                                                                              SizedBox(
                                                                                                                      ...
                                                                                                                      (driverReq['show_request_eta_amount'] == true && driverReq['request_eta_amount'] != null)
                                                                                                                          ? Row(
                                                                                                                              children: [
                                                                                                                                ...
                                                                                                                                MyText(
                                                                                                                                  text: double.parse(driverReq['request_eta_amount'].toString()).toStringAsFixed(2),
                                                                                                                                  size: media.width * fourteen,
                                                                                                                                  fontweight: FontWeight.w500,
                                                                                                                                ),
                                                                                                                              ],
                                                                                                  ...
                                                                                                  children: [
                                                                                                    ...
                                                                                                    Button(
                                                                                                      onTap: () async {
                                                                                                        ...
                                                                                                        var acceptResult = await requestAccept();
                                                                          if (acceptResult == 'already_accepted') {
                                                                            if (mounted) {
                                                                              ScaffoldMessenger.of(context).showSnackBar(
                                                                                SnackBar(
                                                                                  content: Text(languages[choosenLanguage]['text_ride_already_taken'] ?? 'This ride was already accepted by another driver.'),
                                                                                      ...
                                                                                      if ((driverReq['is_driver_arrived'] == 0)) {
                                                                                        ...
                                                                                        if (tripStops.isNotEmpty) {
                                                                                          ...
                                                                                          if (sublist.any((task) => task['completed_at'] == null)) {
                                                                                            ...
                                                                                            debugPrint('🚗 [END_TRIP MULTISTOP] Result: $val | is_completed: ${driverReq['is_completed']} | requestBill: ${driverReq != null && driverReq.isNotEmpty ? driverReq['requestBill'] : 'driverReq is empty'} | currentpage: $currentpage');
                                                                                            if (val == 'logout') {
                                                                                              navigateLogout();
                                                                                            }
                                                                                          }
                                                                                          ...
                                                                                          driverOtp = '';
                                                                                          var val = await endTrip();
                                                                                          debugPrint('🚗 [END_TRIP] Result: $val | is_completed: ${driverReq['is_completed']} | requestBill: ${driverReq != null && driverReq.isNotEmpty ? driverReq['requestBill'] : 'driverReq is empty'} | currentpage: $currentpage');
                                                                                          if (val == 'logout') {
                                                                                            navigateLogout();
                                                                                          }
                                                                                        }
                                                                                        ...
                                                                                        children: [
                                                                                          ...
                                                                                          SizedBox(
                                                                                            ...
                                                                                            child: Text(
                                                                                              ...
                                                                                              style: GoogleFonts.poppins(fontSize: media.width * fourteen, fontWeight: FontWeight.w500, color: buttonColor),
                                                                                              textAlign: TextAlign.center,
                                                                                              maxLines: 2,
                                                                                              overflow: TextOverflow.ellipsis,
                                                                                            ),
                                                                        ...
                                                                        if (tripStops[i]['completed_at'] ==
                                                                          ...
                                                                          Container(
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              (i + 1).toString(),
                                                                              style: GoogleFonts.poppins(fontSize: media.width * sixteen, fontWeight: FontWeight.w500, color: Colors.red),
                                                                            ),
                                                                          ),
                                                                        const SizedBox(
                                                                          height:
