...
bool _pickImage = false;// email of user
String _error = '';
String _permission = '';
            ...
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                          ...
                          Center(
                            child: MyText(
                              text: languages[choosenLanguage]['text_upload_id'],
                                      ...
                                      InkWell(
                                                                                        ...
                                                                                        child: Container(
                                                                                          ...
                                                                                          child: Row(
                                                                                            ...
                                                                                            children: [
                                                                                              Row(
                                                                                                children: [
                                                                                                  SafeImage(url: countries[i]['flag'], width: 28, height: 20, fit: BoxFit.cover),
                                                                                                  SizedBox(
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              SafeImage(url: countries[phcode]['flag'], width: 28, height: 20, fit: BoxFit.cover),
                                              SizedBox(
                                                width: media.width * 0.02,
                                              ),
                                              const SizedBox(
