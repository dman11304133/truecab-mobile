  ...
  navigate(verify) {
    ...
    if (verify == true) {
      if (userDetails['uploaded_document'] == false) {
        debugPrint('🚗 [NAV] → RequiredInformation (uploaded_document=false)');
        ...
        debugPrint('🚗 [NAV] → RequiredInformation (approved=false)');
        Navigator.pushAndRemoveUntil(
            context,
            MaterialPageRoute(
              builder: (context) => const RequiredInformation(),
      ...
      debugPrint('🚗 [NAV] verify=false → going to name/registration page');
      ...
      debugPrint('🚗 [NAV] verify returned error: $verify');
                        ...
                        if (_pinPutController2.length == 6) {
                          ...
                          if (phoneAuthCheck == false) {
                            ...
                            try {
                              ...
                              if (otpResult == 'success') {
                                ...
                                setState(() {
                                  _pinPutController2.clear();
                                  otpNumber = '';
                                  _error = otpResult ?? languages[choosenLanguage]['text_otp_error'];
                                });
                              }
                            } catch (e) {
                              debugPrint('📲 [OTP_VERIFY] Error during verification: $e');
                              setState(() {
                                _error = languages[choosenLanguage]['text_otp_error'];
                              });
                            }
                            ...
                            try {
                              ...
                              debugPrint('📲 [OTP_VERIFY] Firebase/Navigation Error: $e');
                            }
                          }
                          loginLoading = false;
                          valueNotifierLogin.incrementNotifier();
