                                                                ...
                                                                children: [
                                                                  Expanded(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        decoration:
                                                                            BoxDecoration(
                                                                          image: safeImage(vehicledata[i]['type_icon'].toString()),
                                                                      ...
                                                                      child: Column(
                                                                          ...
                                                                          children: [
                                                                            vehicledata[i]['driverDetail'] != null
                                                                                ? MyText(text: vehicledata[i]['driverDetail']['data']['name'].toString(), size: media.width * fourteen, fontweight: FontWeight.w500)
                                                                                : Container(),
                                                                            vehicledata[i]['driverDetail'] != null
                                                                                ? MyText(
