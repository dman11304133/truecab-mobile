                          ...
                          child: Container(
                              ...
                              decoration: BoxDecoration(
                                  borderRadius: (_showEarning == 0)
                                      ...
                                      : null,
                                  color:
                                      (_showEarning == 0) ? buttonColor : page),
                              child: MyText(
                                text: languages[choosenLanguage]['text_today'],
                                size: media.width * fifteen,
                                fontweight: FontWeight.w500,
                                color: (_showEarning == 0) ? buttonText : textColor,
                              )),
                        ),
                        InkWell(
                          onTap: () async {
                          ...
                          child: Container(
                              ...
                              decoration: BoxDecoration(
                                  borderRadius: (_showEarning == 1)
                                      ...
                                      : null,
                                  color:
                                      (_showEarning == 1) ? buttonColor : page),
                              child: MyText(
                                text: languages[choosenLanguage]['text_weekly'],
                                size: media.width * fifteen,
                                fontweight: FontWeight.w500,
                                color: (_showEarning == 1) ? buttonText : textColor,
                              )),
                        ),
                        InkWell(
                          onTap: () async {
                          ...
                          child: Container(
                              ...
                              decoration: BoxDecoration(
                                  borderRadius: (_showEarning == 2)
                                      ...
                                      : null,
                                 color:
                                      (_showEarning == 2) ? buttonColor : page),
                              child: MyText(
                                text: languages[choosenLanguage]['text_report'],
                                size: media.width * fifteen,
                                fontweight: FontWeight.w500,
                                color: (_showEarning == 2) ? buttonText : textColor,
                              )),
                        )
                      ],
                    ),
                                      ...
                                      SizedBox(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            MyText(
                                              text:
                                                  '${driverTodayEarnings['currency_symbol']}${double.parse(driverTodayEarnings['total_earnings'].toString()).toStringAsFixed(2)}',
                                  ...
                                  children: [
                                    ...
                                    MyText(
                                      text: driverTodayEarnings[
                                              'currency_symbol'] +
                                          ' ' +
                                          double.parse(driverTodayEarnings[
                              ...
                              children: [
                                ...
                                MyText(
                                  text: driverTodayEarnings['currency_symbol'] +
                                      ' ' +
                                      double.parse(driverTodayEarnings[
                                              'total_cash_trip_amount'].toString())
                                          .toStringAsFixed(2),
                                  size: media.width * sixteen,
                                ),
                              ],
                                ...
                                children: [
                                  ...
                                  MyText(
                                    text: driverTodayEarnings[
                                            'currency_symbol'] +
                                        ' ' +
                                        double.parse(driverTodayEarnings['total_earnings']
                                            .toString()).toStringAsFixed(2),
                                    size: media.width * sixteen,
                                    color: buttonColor,
                                  ),
                            ...
                            ? Column(children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    MyText(
                                      text:
                                          double.parse(driverWeeklyEarnings['total_earnings'].toString())
                                              .toStringAsFixed(2),
                                      size: media.width * eighteen,
                                    ),
                                  ],
